...
class TestFloor {
	...
	/**
	 * Test to check if the floor is initially dead.
	 */
	@Test
	...
	/**
	 * Test to check the floor parser.
	 */
	@Test
	...
	/**
	 * Test to check if the message of the floor message queue is equal to the floor's message.
	 */
	@Test
	...
	/**
	 * Test to check the name of floor system.
	 */
	@Test
	...
	/**
	 * Test to check if the request from the floor has been sent to the message queue.
	 */
	@Test
